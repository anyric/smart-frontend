            ...
            <v-card class="px-2 mb-5">
                <div class="mr-1 py-3 pl-3 pr-8">
                    ...
                    <div class="row pb-0 mb-0">
                        <div class="col-2"><v-btn small @click="seats('seat_1')" id="seat_1">1</v-btn></div>
                        <div class="col-2  pl-5"><v-btn small id="seat_2" @click="seats('seat_2')">2</v-btn></div>
                        <div class="col-3">&nbsp;</div>
                        <div class="col-5 text-right pr-0"><v-btn small disabled><small>Driver</small></v-btn></div>
                    </div>
                    <div class="row py-0">
                    ...
                    <div class="row py-0">
                        <div class="col-2"><v-btn small @click="seats('seat_7')" id="seat_7">7</v-btn></div>
                        <div class="col-2 pl-5"><v-btn small @click="seats('seat_8')" id="seat_8">8</v-btn></div>
                        <div class="col-4">&nbsp;</div>
                        <div class="col-2"><v-btn small @click="seats('seat_9')" id="seat_9">9</v-btn></div>
                    ...
                    <div class="row py-0">
                        ...
                        <div class="col-2">&nbsp;</div>
                        <div class="col-2"><v-btn small @click="seats('seat_11')" id="seat_11">11</v-btn></div>
                        <div class="col-2"><v-btn small @click="seats('seat_12')" id="seat_12">12</v-btn></div>
                    </div>
                    <div class="row py-0">
                        <div class="col-2"><v-btn small @click="seats('seat_13')" id="seat_13">13</v-btn></div>
                        <div class="col-2" ><v-btn small disabled><small>STAFF</small></v-btn></div>
                        <div class="col-4">&nbsp;</div>
                        <div class="col-2"><v-btn small @click="seats('seat_14')" id="seat_14">14</v-btn></div>
                        <div class="col-2"><v-btn small @click="seats('seat_15')" id="seat_15">15</v-btn></div>
                    </div>
                    <div class="row py-0">
                        <div class="col-2"><v-btn small @click="seats('seat_16')" id="seat_16">16</v-btn></div>
                        <div class="col-2 pl-5"><v-btn small @click="seats('seat_17')" id="seat_17">17</v-btn></div>
                        <div class="col-4">&nbsp;</div>
                        <div class="col-2"><v-btn small @click="seats('seat_18')" id="seat_18">18</v-btn></div>
                        <div class="col-2"><v-btn small @click="seats('seat_19')" id="seat_19">19</v-btn></div>
                    </div>
                    <div class="row py-0">
                        <div class="col-2"><v-btn small @click="seats('seat_20')" id="seat_20">20</v-btn></div>
                        ...
                        <div class="col-2"><v-btn small @click="seats('seat_23')" id="seat_23">23</v-btn></div>
                    </div>
                    <div class="row py-0">
                        <div class="col-2"><v-btn small @click="seats('seat_24')" id="seat_24">24</v-btn></div>
                        <div class="col-2"><v-btn small @click="seats('seat_25')" id="seat_25">25</v-btn></div>
                        <div class="col-4">&nbsp;</div>
                    ...
                    <div class="row py-0">
                        <div class="col-2"><v-btn small @click="seats('seat_28')" id="seat_28">28</v-btn></div>
                        <div class="col-2 pl-5"><v-btn small @click="seats('seat_29')" id="seat_29">29</v-btn></div>
                        <div class="col-4">&nbsp;</div>
                        <div class="col-2"><v-btn small @click="seats('seat_30')" id="seat_30">30</v-btn></div>
                        <div class="col-2"><v-btn small @click="seats('seat_31')" id="seat_31">31</v-btn></div>
                    </div>
                    <div class="row py-0">
                        <div class="col-2"><v-btn small @click="seats('seat_32')" id="seat_32">32</v-btn></div>
                        <div class="col-2 pl-5"><v-btn small @click="seats('seat_33')" id="seat_33">33</v-btn></div>
                        <div class="col-4">&nbsp;</div>
                        <div class="col-2"><v-btn small @click="seats('seat_34')" id="seat_34">34</v-btn></div>
                        <div class="col-2"><v-btn small @click="seats('seat_35')" id="seat_35">35</v-btn></div>
                    </div>
                    <div class="row py-0">
                        <div class="col-2"><v-btn small @click="seats('seat_36')" id="seat_36">36</v-btn></div>
                        <div class="col-2 pl-5"><v-btn small @click="seats('seat_37')" id="seat_37">37</v-btn></div>
                        <div class="col-4">&nbsp;</div>
                        <div class="col-2"><v-btn small @click="seats('seat_38')" id="seat_38">38</v-btn></div>
                        <div class="col-2"><v-btn small @click="seats('seat_39')" id="seat_39">39</v-btn></div>
                    </div>
                    <div class="row">
                        <div class="col-2"><v-btn small @click="seats('seat_40')" id="seat_40">40</v-btn></div>
                        ...
                        <div class="col-2"><v-btn small @click="seats('seat_43')" id="seat_43">43</v-btn></div>
                    </div>
                    <div class="row">
                        <div class="col-2"><v-btn small @click="seats('seat_44')" id="seat_44">44</v-btn></div>
                        <div class="col-3"><v-btn small @click="seats('seat_45')" id="seat_45">45</v-btn></div>
                        <div class="col-3"><v-btn small @click="seats('seat_46')" id="seat_46">46</v-btn></div>
                        <div class="col-2"><v-btn small @click="seats('seat_47')" id="seat_47">47</v-btn></div>
                        <div class="col-2"><v-btn small @click="seats('seat_48')" id="seat_48">48</v-btn></div>
                    </div>
                </div>
            </v-card>
            <div class="mx-5">&nbsp;</div>
...
export default {
    ...
    methods: {
        ...
        seats(btn) {
            if(this.selectedSeat | this.selectedSeat === document.getElementById(btn).innerText ){
                document.getElementById('seat_'+this.selectedSeat).style.backgroundColor = ""
            }
            ...
            this.selectedSeat = document.getElementById(btn).innerText
            document.getElementById('pickpoint').focus();
        },

        choice() {
            this.trip["selected_seat"] = this.selectedSeat;
            this.trip["pick_up_point"] = this.pickPoint;
            this.trip["stop_point"] = this.stopPoint;
            this.trip["am_or_pm"] = this.amOrPM;

            if(this.selectedSeat == '' | this.pickPoint == '' | this.stopPoint == '') {
        ...
        restoreData() {
            ...
            if(data){
                ...
                this.selectedSeat = data.selected_seat;
                if(this.selectedSeat){
                    document.getElementById('seat_'+this.selectedSeat).style.backgroundColor = "#1976d2"
                }
            }
            this.checkSeat();
        },
        ...
        checkField(){
            if(this.selectedSeat.length < 1 | this.pickPoint == '') {
                this.emptyField = true;
            }else{
                this.emptyField = false;
            }
        ...
        checkSeat(){
            this.tickets.forEach(item => {
                const fleet_type = this.fleetTypes.filter(fleet => fleet.id == item.fleet_type);
                if(fleet_type[0].name.split(" ")[0] == 'Premium') {
                    this.bookedSeat.push(item.seat);
                    if(this.bookedSeat){
                        this.bookedSeat.forEach( item => {
